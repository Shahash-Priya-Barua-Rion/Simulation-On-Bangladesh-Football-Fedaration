 ...
 * @author Dell
 */
public class FXMLDecideBudgetController implements Initializable {

    @FXML
    private TableColumn<?, ?> transportCostTableView;
    @FXML
    private TableColumn<?, ?> markettingCostTableView;
    @FXML
    private TableColumn<?, ?> foodCostTableView;
    @FXML
    private TableColumn<?, ?> volunteerCostTableView;
    @FXML
    private TableColumn<?, ?> staffCostTableView;
    @FXML
    private TableColumn<?, ?> othersCostTableView;
