 ...
 * @author DELL
 */
public class FXMLAppointmentMedController implements Initializable {
    ...
    @FXML
    private TableColumn<?, ?> appointmentTimeTableView;
    @FXML
    private TableColumn<?, ?> doctorNameTableView;
    @FXML
    private TableColumn<?, ?> appointmentDateTableView;
    @FXML
    private TableColumn<?, ?> doctorNameTableView1;
