 ...
 * @author Dell
 */
public class FXMLEmployeeSalaryController implements Initializable {
   ...
   departmentComboBox.getItems().addAll("Medical", "Player", "Competition", "Financial", "Media", "Coach", "Development"); 
    ...
    private void submitOnClick(ActionEvent event) throws IOException {
        Parent mainSceneParent = FXMLLoader.load(getClass().getResource("FXMLEmployeeSalaryNext.fxml"));
