 ...
 * @author Dell
 */
public class FXMLEmployeeBonusController implements Initializable {
    ...
    @FXML
    private TextField bonusAmountTextField1;
    @FXML
    ...
    private void submitOnClick(ActionEvent event) throws IOException {
        Parent mainSceneParent = FXMLLoader.load(getClass().getResource("FXMLEmployeeBonusNext.fxml"));
