 ...
 * @author Dell
 */
public class FXMLGetNotificationController implements Initializable {
    ...
    private void goBackOnClick(ActionEvent event) throws IOException {
        Parent mainSceneParent = FXMLLoader.load(getClass().getResource("FXMLMediaDepartmentHomePage.fxml"));
